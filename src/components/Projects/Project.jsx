  ...
  return (
    <div className="max-w-sm  border border-gray-200 rounded-lg shadow bg-[#101319] dark:border-gray-700">
      <a href={props.demo} rel="noreferrer" target="_blank">
        <img className="rounded-t-lg" src={props.img} loading="lazy" alt="project" />
      </a>
      <div className="p-5">
        <a href={props.demo} rel="noreferrer" target="_blank">
        ...
        <div className=" flex gap-[1rem] justify-center my-2 ">
          <a
            href={props.github}
            rel="noreferrer"
            target="_blank"
            className="inline-flex gap-[0.5rem] items-center content-center px-3 py-3 my-2 text-sm font-medium text-center  rounded-md border focus:ring-4 focus:outline-none mr-2 mb-2 border-gray-600 text-gray-400 hover:text-white hover:bg-gray-600 focus:ring-gray-800"
          >
            Github
